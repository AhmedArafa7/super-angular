# halaltube Module Architecture

## Overview

halaltube is a fully featured, decentralized video streaming and discovery module inspired by YouTube. It supports robust playback via Piped API / YouTube IFrame fallbacks, ambient lighting extraction, offline video caching, shorts navigation, channel subscriptions, and upload moderation.

## Key Services & Components

- **`halaltubeService` (`halaltube.service.ts`):** Manages video feeds, trending algorithms, watch history, subscriptions, and offline sync.
