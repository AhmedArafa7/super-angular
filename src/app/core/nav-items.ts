...
export const ALL_NAV_ITEMS: NavItem[] = [
  { id: "dashboard", label: "لوحة التحكم", icon: "layout-dashboard", restricted: false, isPermanent: true, status: 'BETA', route: 'dashboard', category: 'core', aliases: ['الرئيسية', 'لوحة', 'home', 'main'] },
  ...
  { id: "qa", label: "الأسئلة والطلبات", icon: "message-circle-question", restricted: false, isPermanent: true, status: 'BETA', route: 'qa', category: 'core', aliases: ['استفسارات', 'طلبات', 'سؤال', 'q&a', 'faq'] },
  ...
  { id: "ai-games", label: "ألعاب الذكاء الاصطناعي", icon: "sparkles", restricted: false, isPermanent: true, status: 'NEW', route: 'arcade/ai-games', category: 'ai', aliases: ['العاب ذكاء اصطناعي', 'ai games', 'العاب ai', 'توليد العاب', 'العاب ذاتية'] },
  ...
  { id: "notifications", label: "التنبيهات", icon: "bell", restricted: false, isPermanent: true, route: 'notifications', category: 'core', aliases: ['اشعارات', 'تنبيهات', 'notifications', 'alerts', 'hub'] },
  { id: "chat", label: "الدردشة الذكية", icon: "message-square", restricted: false, isPermanent: true, route: 'chat', category: 'ai', aliases: ['شات', 'ذكاء اصطناعي', 'chat', 'ai', 'gpt', 'محادثة', 'روبوت'] },
  { id: "agent-ai", label: "المهندس المساعد", icon: "cpu", restricted: false, isPermanent: true, status: 'BETA', route: 'agent-ai', category: 'ai', aliases: ['مهندس', 'وكيل ذكي', 'agent', 'مساعد', 'برمجة ذكية'] },
  ...
  { id: "csharp-to-ts", label: "محول C# DTO إلى TypeScript", icon: "server", restricted: false, isPermanent: true, status: 'NEW', route: 'csharp-to-ts', category: 'dev', aliases: ['csharp', 'c#', 'dto', 'net', 'dotnet', 'typescript', 'converter', 'تحويل كود', 'موديلز', 'باك اند', 'backend'] },
  ...
  { id: "calculator", label: "الآلة الحاسبة العلمية", icon: "calculator", restricted: false, isPermanent: true, status: 'NEW', route: 'calculator', category: 'tools', aliases: ['حاسبة', 'آلة حاسبة', 'calculator', 'calc', 'رياضيات', 'حساب'] },
  ...
  { id: "device-files", label: "مدير ملفات الجهاز", icon: "hard-drive", restricted: false, isPermanent: true, status: 'NEW', route: 'device-files', category: 'tools', aliases: ['ملفات الجهاز', 'قرص', 'ديسكتوب', 'device manager', 'device files', 'الهارد', 'سلة المهملات'] },
  ...
  { id: "ocr", label: "استخراج النصوص (OCR)", icon: "scan-text", restricted: false, isPermanent: true, status: 'NEW', route: 'ocr', category: 'tools', aliases: ['ocr', 'استخراج نص', 'صورة لنص', 'قارئ الصور', 'مسح ضوئي', 'قراءة الصور', 'scan', 'text extract', 'ocr reader', 'تفريغ الصور'] },
  ...
  { id: "deals", label: "عروض المحلات", icon: "tag", restricted: false, isPermanent: true, status: 'PRO', route: 'deals', category: 'tools', aliases: ['تخفيضات', 'عروض', 'خصومات', 'deals', 'discounts'] },
  ...
  { id: "meeting", label: "Super Meet", icon: "video", restricted: false, isPermanent: true, status: 'NEW', route: 'meeting', category: 'core', aliases: ['ميتنج', 'اجتماع', 'مكالمة', 'فيديو', 'meeting', 'zoom', 'call', 'webrtc', 'sfu'] },
  ...
  { id: "ads", label: "مركز الإعلانات", icon: "megaphone", restricted: false, isPermanent: true, status: 'PRO', route: 'ads', category: 'tools', aliases: ['اعلانات', 'ترويج', 'ads'] },
  { id: "launcher", label: "مشغل المواقع", icon: "rocket", restricted: false, category: 'tools', aliases: ['مواقع', 'مشغل', 'launcher'] },
  { id: "offers", label: "تدفق العروض والتفاوض", icon: "repeat", restricted: false, isPermanent: true, route: 'offers', category: 'tools', aliases: ['عروض خاصة', 'offers', 'تفاوض', 'عروض', 'negotiation'] },
  ...
  { id: "directory", label: "سجل العقد الحية", icon: "users", restricted: false, isPermanent: true, status: 'NEW', route: 'directory', category: 'tools', aliases: ['اعضاء', 'دليل', 'مستخدمين', 'users', 'العقد', 'directory'] },
